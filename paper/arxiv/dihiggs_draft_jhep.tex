...
%%%%%%%%%%%%%%%%%%%%%%%%% Start paper %%%%%%%%%%%%%%%%%%%%%%%%%
%\title{\boldmath Learning About Machine Learning With Di-Higgs Production at the LHC} % i still think this is a great title [BBT, Sept 11 2020]
...
\emailAdd{benjamin.tannenwald@cern.ch}
...
\begin{document} 
%\linenumbers # option for including line numbers in draft-mode
\maketitle
\flushbottom
